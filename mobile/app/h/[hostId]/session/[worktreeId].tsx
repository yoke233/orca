...
import { MobileFilePreviewContent } from '../../../../src/session/MobileFilePreviewContent'
...
function FileReader({
  ...
  const syntaxSegments =
    fileSyntax?.doc === doc && fileSyntax.language === syntaxLanguage
      ? fileSyntax.segments
      : undefined
  return <MobileFilePreviewContent doc={doc} title={title} syntaxSegments={syntaxSegments} />
}
