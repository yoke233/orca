...
import { RpcClientContext, useRpcClientContext } from './rpc-client-react-context'
 ...
 *  it to decide which screens are this document's. Separate from the shared context so the contract above
