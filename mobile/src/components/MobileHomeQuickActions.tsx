...
import type { MobileTranslator } from '../localization/mobile-locale'
...
export function MobileHomeQuickActions(props: Props) {
  ...
  return (
    <>
      <Text style={styles.sectionHeading}>{props.t('home.quickActions')}</Text>
      <View style={styles.quickActions}>
        ...
        >
          ...
          <Text style={styles.quickActionLabel}>{props.t('home.pairDesktop')}</Text>
        </Pressable>
        <Pressable
          accessibilityRole="button"
        ...
        >
          ...
          <Text style={styles.quickActionLabel}>{props.t('home.newWorkspace')}</Text>
        </Pressable>
      </View>
      <PickerModal
        visible={hostPickerVisible}
        title={props.t('home.createWorkspaceOn')}
